...
- Clone the repository using the following command: git clone https://github.com/jash-debug/math-magicians.git
...
Feel free to check the [issues page](https://github.com/jash-debug/math-magicians/issues).
